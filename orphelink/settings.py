"""
Django settings for orphelink project.
...
SECRET_KEY = 'django-insecure-2^d8_4is+&=a77%ate41gxmv7gnusoommd*jxdm1=r(k121d!)'
...
WSGI_APPLICATION = 'orphelink.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'donia_db',
        'USER': 'postgres',
        'PASSWORD': '123',  # Ajustez avec votre mot de passe PostgreSQL
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
